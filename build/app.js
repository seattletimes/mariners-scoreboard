...
},{"./src/responsive-child/responsive-child.js":4}],2:[function(require,module,exports){
"use strict";
...
var ampResize = function ampResize(height) {
...
var Guest = function Guest(element, callback) {
...
Guest.prototype = {
  ...
  //parse message event
  parseEvent: function parseEvent(e) {
    var data = e.data;
...
},{"../makeEvent":2,"./guest.js":3,"./responsive-child.less":5,"document-register-element":7}],5:[function(require,module,exports){
...
(function (e, t, n, r) {
  ...
  function rt(e, t) {
    ...
    var t = e.currentTarget,
        n = e.attrChange,
        r = e.prevValue,
        i = e.newValue;Q && t.attributeChangedCallback && e.attrName !== "style" && t.attributeChangedCallback(e.attrName, n === e[a] ? null : r, n === e[l] ? null : i);
  }function ft(e) {
    ...
    p = n.toUpperCase(), $ || ($ = !0, P ? (et = function (e, t) {
      function n(e, t) {
        ...
        for (var i, s, o = 0, u = r.length; o < u; o++) {
          i = r[o], i.type === "childList" ? (n(i.addedNodes, e), n(i.removedNodes, t)) : (s = i.target, Q && s.attributeChangedCallback && i.attributeName !== "style" && s.attributeChangedCallback(i.attributeName, i.oldValue, s.getAttribute(i.attributeName)));
        }
      });
...
},{"component-responsive-frame/child":1}]},{},[8])
